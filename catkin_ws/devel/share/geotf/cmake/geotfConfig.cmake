...
if("TRUE" STREQUAL "TRUE")
  set(geotf_SOURCE_PREFIX /home/ardalan/catkin_ws/src/geodetic_utils/geotf)
  set(geotf_DEVEL_PREFIX /home/ardalan/catkin_ws/devel)
  set(geotf_INSTALL_PREFIX "")
  set(geotf_PREFIX ${geotf_DEVEL_PREFIX})
else()
  set(geotf_SOURCE_PREFIX "")
  set(geotf_DEVEL_PREFIX "")
  set(geotf_INSTALL_PREFIX /home/ardalan/catkin_ws/install)
...
if(NOT "/home/ardalan/catkin_ws/src/geodetic_utils/geotf/include " STREQUAL " ")
  set(geotf_INCLUDE_DIRS "")
  set(_include_dirs "/home/ardalan/catkin_ws/src/geodetic_utils/geotf/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geotf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ardalan/catkin_ws/src/geodetic_utils/geotf/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND geotf_EXPORTED_TARGETS ${${geotf_dep}_EXPORTED_TARGETS})
endforeach()
