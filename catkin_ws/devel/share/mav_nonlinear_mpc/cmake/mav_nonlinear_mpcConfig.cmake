...
if("TRUE" STREQUAL "TRUE")
  set(mav_nonlinear_mpc_SOURCE_PREFIX /home/ardalan/catkin_ws/src/mav_control_rw/mav_nonlinear_mpc)
  set(mav_nonlinear_mpc_DEVEL_PREFIX /home/ardalan/catkin_ws/devel)
  ...
  set(mav_nonlinear_mpc_INSTALL_PREFIX /home/ardalan/catkin_ws/install)
...
if(NOT "/home/ardalan/catkin_ws/devel/include;/home/ardalan/catkin_ws/src/mav_control_rw/mav_nonlinear_mpc/include " STREQUAL " ")
  set(mav_nonlinear_mpc_INCLUDE_DIRS "")
  set(_include_dirs "/home/ardalan/catkin_ws/devel/include;/home/ardalan/catkin_ws/src/mav_control_rw/mav_nonlinear_mpc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mav_nonlinear_mpc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ardalan/catkin_ws/src/mav_control_rw/mav_nonlinear_mpc/${idir}'.  ${_report}")
    endif()
...
set(depends "mav_msgs;std_msgs;cmake_modules;roscpp;dynamic_reconfigure;tf;mav_control_interface;mav_disturbance_observer")
foreach(depend ${depends})
  ...
  list(APPEND mav_nonlinear_mpc_EXPORTED_TARGETS ${${mav_nonlinear_mpc_dep}_EXPORTED_TARGETS})
endforeach()
