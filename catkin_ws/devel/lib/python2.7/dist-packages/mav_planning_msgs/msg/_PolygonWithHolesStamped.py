...
"""autogenerated by genpy from mav_planning_msgs/PolygonWithHolesStamped.msg. Do not edit."""
import codecs
import sys
...
float64 y
"""
  __slots__ = ['header','altitude','polygon']
  _slot_types = ['std_msgs/Header','float64','mav_planning_msgs/PolygonWithHoles']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.polygon is None:
        self.polygon = mav_planning_msgs.msg.PolygonWithHoles()
    else:
      self.header = std_msgs.msg.Header()
      self.altitude = 0.
      self.polygon = mav_planning_msgs.msg.PolygonWithHoles()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.polygon.holes:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.polygon.hull.points.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.polygon.holes = []
